...
$messages['zh-hans'] = array(
	...
	'semanticformsinputs-datepicker-disabledates' => '已禁用日期逗号分隔列表/日期范围 (日期采用dd/yyyy/mm格式，日期范围采用yyyy/mm/dd-yyyy/mm/dd格式）。',
	'semanticformsinputs-datepicker-highlightdates' => '高亮显示日期逗号分隔列表/日期范围（日期采用dd/yyyy/mm格式，日期范围采用yyyy/mm/dd-yyyy/mm/dd格式）。',
