...
$6',
	...
	'right-codereview-review-own' => 'Merkañ ar gwiriadennoù graet ganeoc\'h evel "{{int:code-status-ok}}" pe "{{int:code-status-resolved}}"',
	'action-repoadmin' => 'melestriñ ar fiziadoù kod',
	'action-codereview-use' => 'implijout Dibar:Kod',
	'action-codereview-add-tag' => "ouzhpennañ tikedennoù nevez d'an adweladennoù",
	'action-codereview-remove-tag' => "tennañ balizennoù d'an adweladennoù",
	'action-codereview-post-comment' => "ouzhpennañ evezhiadennoù d'an adweladennoù",
	'action-codereview-set-status' => 'kemmañ statud an adweladennoù',
	'action-codereview-signoff' => 'aprouiñ adweladennoù',
	'action-codereview-link-user' => "liammañ an oberourien d'an implijerien wiki",
	'action-codereview-associate' => "ouzhpennañ/lemel ar c'henstroll adwelet",
	'action-codereview-review-own' => 'merkañ ar gwiriadennoù graet ganeoc\'h evel "{{int:code-status-ok}}" pe "{{int:code-status-resolved}}"',
...
$6',
	...
	'right-codereview-review-own' => 'نسخه‌های خود را به عنوان «{{int:code-status-ok}}» یا «{{int:code-status-resolved}}» علامت گذاری کنید',
	'action-repoadmin' => 'مدیریت مخازن کد',
...
$messages['he'] = array(
	...
	'code-signoff-strike' => 'מחיקת החתימות הנבחרות בקו חוצה',
	...
	'code-signoff-struckdate' => '$1 (נמחקו בקו חוצה ב־$2)',
...
$6',
	...
	'right-codereview-review-own' => 'Markaam dagiti bukodmo a rebision a kas "{{int:code-status-ok}}" wenno "{{int:code-status-resolved}}"',
...
$messages['ka'] = array(
	...
	'code-signoff-flag-inspected' => 'შემოწმებულია',
	...
	'code-pathsearch-filter' => 'აჩვენე მხოლოდ:',
...
ახალი სტატუსი: $4',
	...
	'grouppage-svnadmins' => '{{ns:project}}:SVN ადმინისტრატორები',
);
...
De gegevens kunnen uit een cache komen.',
	...
	'code-rev-diff-link' => 'wijzigingen',
...
$6',
	...
	'right-codereview-review-own' => 'Eigen commits als "{{int:code-status-ok}}" of "{{int:code-status-resolved}}" markeren',
	'action-repoadmin' => 'coderepositories te beheren',
	'action-codereview-use' => 'Special:Code te gebruiken',
	'action-codereview-add-tag' => 'nieuwe labels aan versies toe te voegen',
	'action-codereview-remove-tag' => 'labels van versies te verwijderen',
	'action-codereview-post-comment' => 'opmerkingen aan versies toe te voegen',
	'action-codereview-set-status' => 'versiestatus te wijzigen',
	'action-codereview-signoff' => 'versies goed te keuren',
	'action-codereview-link-user' => 'auteurs aan wikigebruikers te koppelen',
	'action-codereview-associate' => 'versiekoppelingen toe te voegen of te verwijderen',
	'action-codereview-review-own' => 'eigen versies als "{{int:code-status-ok}} of "{{int:code-status-resolved}}" te markeren',
...
$messages['pl'] = array(
	...
	'code-referenced' => 'Następujące wersje',
...
$6',
	...
	'right-codereview-use' => 'Korzystanie ze Special:Code',
	...
	'action-repoadmin' => 'zarządzanie kodem repozytoriów',
	'action-codereview-use' => 'użyj Special:Code',
	'action-codereview-add-tag' => 'dodaj nowe znaczniki do wersji',
	'action-codereview-remove-tag' => 'usuń znaczniki z wersji',
	'action-codereview-post-comment' => 'dodaj komentarze do wersji',
	'action-codereview-set-status' => 'zmień status wersji',
	'action-codereview-signoff' => 'wypisz się z wersji',
	'action-codereview-link-user' => 'połącz autorów z użytkownikami wiki',
	'action-codereview-associate' => 'zarządzaj powiązaniami wersji',
	'action-codereview-review-own' => 'zaznacz własne "{{int:code-status-ok}}" lub "{{int:code-status-resolved}}"',
...
$6',
	...
	'right-codereview-add-tag' => 'Gắn thẻ mới vào thay đổi',
	'right-codereview-remove-tag' => 'Gỡ thẻ khỏi thay đổi',
	'right-codereview-post-comment' => 'Ghi chú về thay đổi',
	'right-codereview-set-status' => 'Thay đổi trạng thái của thay đổi',
	'right-codereview-signoff' => 'Tán thành các thay đổi',
	'right-codereview-link-user' => 'Liên kết tác giả mã nguồn đến thành viên wiki',
	'right-codereview-associate' => 'Quản lý các liên kết giữa các thay đổi',
	'right-codereview-review-own' => 'Đánh dấu các thay đổi của riêng bạn là “{{int:code-status-ok}}” hoặc “{{int:code-status-resolved}}”',
	'action-repoadmin' => 'quản lý các kho mã',
	'action-codereview-use' => 'sử dụng Đặc biệt:Mã nguồn',
	'action-codereview-add-tag' => 'gắn thẻ mới vào thay đổi',
	'action-codereview-remove-tag' => 'gỡ thẻ khỏi thay đổi',
	'action-codereview-post-comment' => 'ghi chú về thay đổi',
	'action-codereview-set-status' => 'thay đổi trạng thái của thay đổi',
	'action-codereview-signoff' => 'tán thành các thay đổi',
	'action-codereview-link-user' => 'liên kết tác giả mã nguồn đến thành viên wiki',
	'action-codereview-associate' => 'quản lý các liên kết giữa các thay đổi',
	'action-codereview-review-own' => 'đánh dấu các sửa đổi của riêng bạn là “{{int:code-status-ok}}” hoặc “{{int:code-status-resolved}}”',
