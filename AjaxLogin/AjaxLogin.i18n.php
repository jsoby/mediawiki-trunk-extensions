 ...
 */
$messages['fa'] = array(
	'ajaxlogin-desc' => 'جعبهٔ پویا که اجازه می‌دهد تا کاربران از این طریق به سامانه وارد شوند و حتی برای گرفتن گذرواژهٔ فراموش شده از طریق پست الکترونیکی نیز کمک می‌کند',
