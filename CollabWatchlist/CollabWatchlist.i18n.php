 ...
 */
$messages['es'] = array(
	'collabwatchlist' => 'Lista de seguimiento colaborativa',
	'collabwatchlist-desc' => 'Proporciona listas de seguimiento colaborativas basadas en categorías',
	'specialcollabwatchlist' => 'Página especial de lista de seguimiento colaborativa',
	'collabwatchlist-details' => '{{PLURAL:$1|$1 categoría/página|$1 categorías/páginas}} en esta lista de seguimiento colaborativa.',
	'collabwatchlisttagselect' => 'Etiqueta',
	'collabwatchlisttagcomment' => 'Comentario',
	'collabwatchlistsettagbutton' => 'Definir etiqueta',
	'collabwatchlisttools-view' => 'Visualización',
	'collabwatchlisttools-edit' => 'Editar categorías',
	'collabwatchlisttools-rawCategories' => 'Editar categorías en bloque',
	'collabwatchlisttools-rawTags' => 'Edición de etiquetas en bloque',
	'collabwatchlisttools-rawUsers' => 'Editar usuarios en bloque',
	'collabwatchlisttools-delete' => 'Eliminar',
	'collabwatchlistsall' => 'Todas las listas',
	'collabwatchlistfiltertags' => 'Ocultar etiquetas',
	'collabwatchlistedit-users-raw-submit' => 'Guardar',
	'collabwatchlistedit-raw-title' => 'Editar categorías en bloque',
	'collabwatchlistedit-tags-raw-title' => 'Edición de etiquetas en bloque',
	'collabwatchlistedit-users-raw-title' => 'Editar usuarios en bloque',
	'collabwatchlistedit-users-last-owner' => 'Debe haber al menos un propietario',
	'collabwatchlistedit-numitems' => 'Esta lista de seguimiento colaborativa contiene {{PLURAL:$1|1 categoría|$1 categorías}}',
	'collabwatchlistedit-noitems' => 'Esta lista de seguimiento colaborativa no contiene ninguna categoría.',
	'collabwatchlistedit-tags-numitems' => 'Esta lista de seguimiento colaborativa contiene {{PLURAL:$1|1 etiqueta|$1 etiquetas}}',
	'collabwatchlistedit-tags-noitems' => 'Esta lista de seguimiento colaborativa no contiene ninguna etiqueta.',
	'collabwatchlistedit-users-numitems' => 'Esta lista de seguimiento colaborativa contiene {{PLURAL:$1|1 usuario|$1 usuarios}}',
	'collabwatchlistedit-users-noitems' => 'Esta lista de seguimiento colaborativa no contiene ningún usuario.',
	'collabwatchlistedit-raw-legend' => 'Editar en bloque las categorías de la lista de seguimiento colaborativa',
	'collabwatchlistedit-users-raw-legend' => 'Editar en bloque los usuarios de la lista de seguimiento colaborativa',
	'collabwatchlistedit-tags-raw-legend' => 'Editar en bloque las etiquetas de la lista de seguimiento colaborativa',
	'collabwatchlistedit-raw-explain' => 'Las categorías de la lista de seguimiento colaborativa se muestran a continuación y pueden editarse agregándolas y eliminándolas de la lista.',
	'collabwatchlistedit-tags-raw-explain' => 'Las etiquetas de la lista de seguimiento colaborativa se muestran a continuación y pueden editarse agregándolas y eliminándolas de la lista.',
	'collabwatchlistedit-users-raw-explain' => 'Los usuarios de la lista de seguimiento colaborativa se muestran a continuación y pueden editarse agregándolos y eliminándolos de la lista.',
	...
	'collabwatchlistedit-normal-legend' => 'Quitar categorías de la lista de seguimiento colaborativa',
	'collabwatchlistedit-normal-explain' => 'Las categorías de tu lista de seguimiento colaborativa se muestran a continuación.',
	'collabwatchlistedit-tags-raw-submit' => 'Guardar',
	'collabwatchlistedit-normal-done' => '{{PLURAL:$1|1 categoría fue eliminada|$1 categorías fueron eliminadas}} de la lista de seguimiento colaborativa:',
	'collabwatchlistedit-tags-raw-done' => 'Se ha actualizado la lista de seguimiento colaborativa.',
	'collabwatchlistedit-users-raw-done' => 'Se ha actualizado la lista de seguimiento colaborativa.',
	'collabwatchlistedit-tags-raw-added' => '{{PLURAL:$1|Se ha añadido una etiqueta|Se han añadido $1 etiquetas}}:',
	'collabwatchlistedit-users-raw-added' => '{{PLURAL:$1|Se ha añadido un usuario|Se han añadido $1 usuarios}}:',
	'collabwatchlistedit-tags-raw-removed' => '{{PLURAL:$1|Se ha añadido un usuario|Se han añadido $1 usuarios}}:',
	'collabwatchlistedit-users-raw-removed' => '{{PLURAL:$1|Se ha eliminado un usuario|Se han eliminado $1 usuarios}}:',
	'collabwatchlistinverttags' => 'Invertir el filtro de etiquetas',
	'collabwatchlistpatrol' => 'Verificación de ediciones',
	'collabwatchlisttools-newList' => 'Nueva lista de seguimiento colaborativa',
	'collabwatchlistdelete-legend' => 'Eliminar una lista de seguimiento colaborativa',
 ...
 */
$messages['ru'] = array(
	'collabwatchlist' => 'Совместный список наблюдения',
	'collabwatchlist-desc' => 'Обеспечивает совместные списки наблюдений, основанные на категориях',
	'specialcollabwatchlist' => 'Специальная страница совместного списка наблюдения',
	'collabwatchlist-details' => 'В этом совместном списке наблюдения {{PLURAL:$1|$1 категория/страница|$1 категории/страницы|$1 категорий/страниц}}.',
	'collabwatchlisttagselect' => 'Метка',
	'collabwatchlisttagcomment' => 'Комментарий',
	'collabwatchlistsettagbutton' => 'Установить метку',
	'collabwatchlisttools-view' => 'Дисплей',
	'collabwatchlisttools-edit' => 'Изменить категорию',
	'collabwatchlisttools-rawCategories' => 'Текстовое редактирование категорий',
	'collabwatchlisttools-rawTags' => 'Текстовое редактирование меток',
	'collabwatchlisttools-rawUsers' => 'Текстовое редактирование пользователей',
	...
	'collabwatchlistedit-raw-title' => 'Текстовое редактирование категорий',
	'collabwatchlistedit-tags-raw-title' => 'Текстовое редактирование меток',
	'collabwatchlistedit-users-raw-title' => 'Текстовое редактирование пользователей',
	'collabwatchlistedit-users-last-owner' => 'Должен быть хотя бы один владелец',
	'collabwatchlistedit-numitems' => 'В этом совместном списке наблюдения {{PLURAL:$1|1 категория|$1 категории|$1 категорий}}',
	'collabwatchlistedit-noitems' => 'В этом совместном списке наблюдения нет категорий.',
	'collabwatchlistedit-tags-numitems' => 'В этом совместном списке наблюдения {{PLURAL:$1|1 метка|$1 метки|$1 меток}}',
	'collabwatchlistedit-tags-noitems' => 'В этом совместном списке наблюдения нет меток.',
	'collabwatchlistedit-users-numitems' => 'В этом совместном списке наблюдения {{PLURAL:$1|1 пользователь|$1 пользователя|$1 пользователей}}',
	'collabwatchlistedit-users-noitems' => 'В этом совместном списке наблюдения нет пользователей.',
	'collabwatchlistedit-raw-legend' => 'Текстовое редактирование категорий совместного списка наблюдения',
	'collabwatchlistedit-users-raw-legend' => 'Текстовое редактирование пользователей совместного списка наблюдения',
	'collabwatchlistedit-tags-raw-legend' => 'Текстовое редактирование меток совместного списка наблюдения',
	'collabwatchlistedit-raw-explain' => 'Категории совместного списка наблюдения показаны ниже. Категории можно удалять и добавлять.',
	'collabwatchlistedit-tags-raw-explain' => 'Метки совместного списка наблюдения показаны ниже. Метки можно удалять и добавлять.',
	'collabwatchlistedit-users-raw-explain' => 'Пользователи совместного списка наблюдения показаны ниже. Пользователей можно удалять и добавлять.',
	'collabwatchlistedit-raw-titles' => 'Категории:',
	'collabwatchlistedit-tags-raw-titles' => 'Метки:',
	'collabwatchlistedit-users-raw-titles' => 'Участники:',
	'collabwatchlistedit-normal-title' => 'Редактировать категории',
	'collabwatchlistedit-normal-legend' => 'Удалить категории из совместного списка наблюдения',
	'collabwatchlistedit-normal-explain' => 'Ниже показаны категории вашего совместного списка наблюдения.',
	'collabwatchlistedit-tags-raw-submit' => 'Сохранить',
	'collabwatchlistedit-normal-done' => 'Из совместного списка наблюдения {{PLURAL:$1|была удалена 1 категория|были удалены $1 категории|были удалены $1 категорий}}:',
	'collabwatchlistedit-tags-raw-done' => 'Совместный список наблюдения обновлен.',
	'collabwatchlistedit-users-raw-done' => 'Совместный список наблюдения обновлен.',
	'collabwatchlistedit-tags-raw-added' => '{{PLURAL:$1|Добавлена 1 метка|$1 метки были добавлены|$1 меток были добавлены}}:',
	'collabwatchlistedit-users-raw-added' => '{{PLURAL:$1|Добавлен 1 пользователь|$1 пользователя были добавлены|$1 пользователей были добавлены}}:',
	'collabwatchlistedit-tags-raw-removed' => '{{PLURAL:$1|Удалена 1 метка|$1 метки были удалены|$1 меток были удалены}}:',
	'collabwatchlistedit-users-raw-removed' => '{{PLURAL:$1|Удалена 1 пользователь|$1 пользователя были удалены|$1 пользователей были удалены}}:',
	'collabwatchlistinverttags' => 'Инвертировать фильтр меток',
	'collabwatchlistpatrol' => 'Патрулирование',
	'collabwatchlisttools-newList' => 'Новый совместный список наблюдения',
	'collabwatchlistdelete-legend' => 'Удалить совместный список наблюдения',
	'collabwatchlistdelete-explain' => 'Удаление совместного списка наблюдения удалит все отслеживания. Метки, установленные при редактированиях сохраняются.',
	'collabwatchlistdelete-submit' => 'Удалить',
	'collabwatchlistdelete-title' => 'Удалить совместный список наблюдения',
	'collabwatchlistedit-set-tags-numitems' => 'В совместном списке наблюдения {{PLURAL:$1|установлена 1 метка|установлены $1 метки|установлено $1 меток}}',
	'collabwatchlistedit-set-tags-noitems' => 'В этом совместном списке наблюдения нет меток',
	'collabwatchlistnew-legend' => 'Создать новый совместный список наблюдения',
	'collabwatchlistnew-explain' => 'Имя списка должно быть уникальным.',
	'collabwatchlistnew-name' => 'Название списка',
	'collabwatchlistnew-submit' => 'Создать',
	'collabwatchlistedit-raw-done' => 'Совместный список наблюдения обновлен',
	'collabwatchlistedit-raw-added' => '{{PLURAL:$1|1 страница или категория была добавлена|$1 страницы или категории были добавлены|$1 страниц или категорий были добавлены}}:',
	'collabwatchlistedit-raw-removed' => '{{PLURAL:$1|1 страница или категория была удалена|$1 страницы или категории были удалены|$1 страниц или категорий были удалены}}:',
	'collabwatchlistedit-normal-submit' => 'Сохранить',
	'collabwatchlistshowhidelistusers' => '$1 список пользователей',
	'tog-collabwatchlisthidelistusers' => 'Скрыть изменения от пользователей совместного списка наблюдения',
);
