...
$messages['es'] = array(
	...
	'qpollwebinstall' => 'Instalación / actualización de la extensión QPoll',
	...
	'qp_browse_to_interpretation' => 'Navegar a $1',
	...
	'qp_results_interpretation_header' => 'Interpretación de la respuesta',
	'qp_results_short_interpretation' => 'Interpretación corta',
	'qp_results_long_interpretation' => 'Interpretación larga',
	'qp_results_structured_interpretation' => 'Interpretación estructurada',
	'qp_poll_has_no_interpretation' => 'Esta encuesta no tiene ningún modelo de interpretación definido en su encabezado.',
	'qp_interpetation_wrong_answer' => 'Respuesta incorrecta',
	'qp_export_to_xls' => 'Exportar estadísticas a formato XLS',
	'qp_voices_to_xls' => 'Exportar las voces en formato XLS',
	'qp_interpretation_results_to_xls' => 'Exportar las interpretaciones de respuesta en formato XLS',
...
Asegúrate de que la encuesta está declarada y guardada, y no olvides usar el carácter delimitador de dirección #',
	...
	'qp_error_question_empty_body' => 'El cuerpo de la pregunta está vacío.',
	'qp_error_question_no_proposals' => 'La pregunta no tiene ninguna propuesta definida.',
	'qp_error_invalid_question_type' => 'Tipo de pregunta inválido: $1',
	'qp_error_invalid_question_name' => 'Nombre de pregunta inválido: $1.',
...
El id sólo puede contener letras, números y espacios',
	...
	'qp_error_too_long_dependance_value' => 'El valor del atributo de dependencia (dependencia="$2") de la encuesta (id=$1) es demasiado largo para ser guardado en la base de datos.',
	...
	'qp_error_too_long_category_option_value' => 'El valor de la opción de categoría es demasiado largo para ser guardado en la base de datos.',
	'qp_error_too_long_category_options_values' => 'Los valores de las opciones de categoría son demasiado largos para ser guardados en la base de datos.',
	'qp_error_too_long_proposal_text' => 'El texto de la propuesta es demasiado largo para ser guardado en la base de datos.',
	'qp_error_too_long_proposal_name' => 'El nombre de la propuesta es demasiado largo para ser guardado en la base de datos.',
	'qp_error_multiline_proposal_name' => 'El nombre de la propuesta no puede contener múltiples líneas de texto.',
	'qp_error_numeric_proposal_name' => 'El nombre de la propuesta no puede ser numérico.',
	...
	'qp_error_not_enough_categories_answered' => 'No hay suficientes categorías seleccionadas.',
	'qp_error_unique' => 'La pregunta de tipo único() tiene definidas más propuestas que respuestas posibles: imposible completar',
	'qp_error_no_more_attempts' => 'Ha alcanzado el número máximo de intentos de envío para esta encuesta.',
	'qp_error_no_interpretation' => 'No existe la secuencia de comandos (script) de interpretación.',
	'qp_error_interpretation_no_return' => 'La secuencia de comandos (script) de interpretación no devolvió resultados.',
	'qp_error_structured_interpretation_is_too_long' => 'La interpretación estructurada es demasiado larga para ser guardada en la base de datos. Corrija su secuencia de comandos (script) .',
	'qp_error_no_json_decode' => 'La interpretación de las respuestas a la encuesta necesita la función de PHP json_decode().',
	'qp_error_eval_missed_lang_attr' => 'El atributo "lang" de XML es obligatorio para elegir el idioma de interpretación adecuado.',
	'qp_error_eval_mix_languages' => 'Una misma secuencia de comandos (script)  de interpretación no puede mezclar diferentes idiomas de interpretación: "$1", "$2".',
	'qp_error_eval_unsupported_language' => 'El idioma de interpretación "$1" no está soportado.',
	'qp_error_eval_illegal_token' => 'El token de PHP $1 con valor $2 no está permitido en la línea $3.',
	'qp_error_eval_illegal_superglobal' => 'El token de PHP $1 con valor superglobal $2 no está permitido en la línea $3.',
	'qp_error_eval_illegal_function_call' => 'El token de PHP $1 con la función $2 no está permitido en la línea $3.',
	'qp_error_eval_variable_variable_access' => 'El token de PHP $1 con la variable $2 no está permitido en la línea $3.',
	'qp_error_eval_illegal_variable_name' => 'El token de PHP $1 rechazó el nombre de variable $2 en la línea $3.',
	'qp_error_eval_variable_function_call' => 'El token de PHP $1 con la función variable $2 no está permitido en la línea $3.',
	'qp_error_eval_self_check' => 'La siguiente comprobación automática eval() ha fallado: $1. Tiene una versión de PHP no soportada, que no permite ejecutar secuencias de comandos (script) de evaluación de modo seguro.',
	'qp_error_eval_unable_to_lint' => 'No se pudo controlar (lint). Compruebe la configuración de su sistema.',
);
...
$messages['lb'] = array(
	...
	'qp_results_structured_interpretation' => 'Strukturéiert Interpretatioun',
	...
	'qp_error_invalid_question_name' => 'Numm vun der Fro net valabel: $1',
	...
	'qp_error_too_long_proposal_name' => 'De proposéierten Numm ass ze laang fir an der Datebank gespäichert ze ginn.',
