...
$wgGoogleMapsMessages['ba'] = array(
	...
	'gm-incompatible-browser' => 'Был урында күрһәтелгән картаны күреү өсөн һеҙгә яраҡлы веб-браузер ҡулланырға кәрәк була.',
	'gm-incompatible-browser-link' => 'Яраҡлы веб-браузерҙар исемлеген ҡарау өсөн бында төртөгөҙ',
	'gm-no-editor' => 'Үкенескә ҡаршы һеҙҙең браузер интерактив карта төҙөү функцияһын башҡара алмай. <a href="http://www.microsoft.com/ie">Internet Explorer</a>-ҙың (Windows) йәки <a href="http://www.mozilla.org/products/firefox">Firefox</a>-тың (Windows, Mac, һәм Linux) иң һуңғы версияларын ҡулланып ҡарағыҙ.',
	'gm-balloon-title' => 'Башлыҡ:',
	'gm-balloon-link-article' => 'Был биткә һылтанма (мотлаҡ түгел) :',
	'gm-make-marker' => 'Маркер (вики-тамға бар):',
	'gm-remove' => 'юйырға',
	'gm-caption' => 'Маркер',
	'gm-tab-title' => 'Билгә исеме',
	'gm-tab' => 'Билгә',
	'gm-start-path' => 'маршрут һала башлау',
	'gm-trace-area' => 'өлкәне һыҙып алыу',
	'gm-save-point' => 'һаҡларға һәм ябырға',
	'gm-load-map-from-article' => 'Картаны биттән йөкмәтеп алырға:',
	'gm-no-maps' => 'Был биттән йөкмәтеп аларға карта юҡ:',
	'gm-refresh-list' => 'Исемлекте яңыртыу',
	'gm-load-map' => 'Картаны йөкмәтеү',
	'gm-clip-result' => 'Картаға өҫтәргә',
	'gm-no-results' => 'Ғәфү итегеҙ, бер нимә лә табылманы',
	'gm-searching' => 'эҙләү бара…',
	'gm-map' => 'Карта',
	'gm-note' => 'Иғтибар: "Картаны йөкмәтеү", "Һаҡларға" йәки  "Алдан ҡарап сығырға" төртмәҫтән урын, (аҫтағы) биткә кодты күсереп алырға онотмағыҙ',
	'gm-instructions' => 'Өҫтәге картаны яһау өсөн түбәндә вики-тамғалар килтерелгән.',
	'gm-are-you-sure' => 'Яңылышмайһығыҙмы?',
	'gm-clear-all-points' => 'Бөтә нөктәләрҙе лә юйырға',
	'gm-refresh-points' => 'Нөктөләрҙе аңыртырға',
	'gm-width' => 'Киңлек',
	'gm-height' => 'Бейеклек',
	'gm-scale-control' => 'Шкала',
	'gm-overview-control' => 'Дөйөм күренеш',
	'gm-selector-control' => 'Карта/Спутник һайлау',
	'gm-zoom-control' => 'Навигация',
	'gm-large' => 'Ҙур',
	'gm-medium' => 'Уртаса',
	'gm-small' => 'Бәләкәй',
	'gm-no-zoom-control' => 'Юҡ',
	'gm-yes' => 'Эйе',
	'gm-no' => 'Юҡ',
	'gm-search-preface' => 'Ҡалаға, илгә, адресҡа йәки бизнесҡа күсеү өсөн,  йәки яңы нөктә өҫтәү өсөн картаға төртөгөҙ.',
	'gm-geocode-preface' => 'Ҡалаға, илгә, йәки адресҡа күсеү өсөн,  йәки яңы нөктә өҫтәү өсөн картаға төртөгөҙ:',
	'gm-no-search-preface' => 'Нөктә өҫтәү өсөн картаға төртөгөҙ.',
	'gm-search' => 'Эҙләү',
	'gm-clear-search' => 'эҙләп табылғанды юйыу',
	'gm-meters' => 'метрҙар',
	'gm-miles' => 'мильдәр',
	'gm-editing-path' => 'Ошо юлға күберәк нөктәләр өҫтәү өсөн картаға төртөгөҙ.',
	'gm-save-path' => 'Һаҡларға',
	'gm-edit-path' => 'нөктәләр өҫтәргә',
	'gm-show-path' => 'нөктәләрҙе күрһәтергә',
	'gm-color-path' => 'төҫтө үҙгәртеү',
	'gm-color-fill' => 'тултырып буяу төҫөн үҙгәртеү',
	'gm-add-fill' => 'өлкәне тултырып буярға',
	'gm-remove-fill' => 'тултырып буяҙы бөтөрөү',
	'gm-fill-color' => 'Тултырып буяу төҫө',
	'gm-line-color' => 'Һыҙыҡ төҫө',
	'gm-opacity' => 'Үтә күренмәһеҙлек',
	'gm-line-width' => 'Киңлек',
	'gm-make-map' => 'карта яһау',
	'gm-hide-map' => 'картаны йәшерергә',
	'gm-back' => 'артҡа',
	'gm-kml-include' => 'Тышҡы KML/GeoRSS:',
	'gm-kml-include-link' => 'картаға өҫтәргә',
	'gm-kml-loading' => 'йөкмәтеү...',
	'gm-kml-export' => 'Был картаны KML-ға экспортларға',
	'gm-earth' => 'Ер',
	'gm-moon' => 'Ай',
	'gm-mars' => 'Марс',
);
...
$wgGoogleMapsMessages['fa'] = array(
	...
	'gm-kml-export' => 'برون‌بری این نقشه به کی‌ام‌ال',
	'gm-earth' => 'زمین',
	'gm-moon' => 'ماه',
	'gm-mars' => 'مریخ',
);
